    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 药品录入
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="form-box">
                <el-form :model="formData" ref="formData" label-width="110px" class="demo-formData">
                    ...
                    <el-form-item label="特别注意">
                        <el-input
                            v-model="formData.careabout"
                            type="textarea"
                            :autosize="{ minRows: 3}"
                        ></el-input>
                    </el-form-item>
...
<script>
import { addCommodity, getQiniuToken } from '@/api/index.js';
...
export default {
    ...
    methods: {
        ...
        handleSuccess1(res, file) {
            this.formData.images.push(this.upload_qiniu_addr + res.key);
        },
        handleError1(res) {
            this.$message({
                message: '上传失败',
